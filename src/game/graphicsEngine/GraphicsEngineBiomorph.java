 ...
 *  
 */
public class GraphicsEngineBiomorph extends GraphicsEngineActorPlayer {
	...
	public GraphicsEngineBiomorph(LogicActorPlayer logic, Direction initial) {
		super(logic, initial);
		frameDuration = 10;
		loadAnimations();
	...
	public void loadAnimations(){
		...
		TreeMap anims=(TreeMap)animSet.getAnims().get("biomorph");
