 ...
 * funcionalidades concretas al proyectil rectilnhneo de los biomorphs
 */
public class ActorAmmoProjRectilinearBiomorph extends ActorAmmoProjRectilinear {
     ...
     */
    public ActorAmmoProjRectilinearBiomorph(Stage stage, ActorPlayer owner,
            int power) {
        super(stage, owner);
        int damage=0;
        int radius=0;
        ...
        case Constants.POW_1:
            ...
            + "proyectiles" + File.separator + "pua_recto1.png";
        ...
        case Constants.POW_2:
        	route = "art" + File.separator + "biomorph" + File.separator
            + "proyectiles" + File.separator + "pua_recto2.png";
        ...
        case Constants.POW_3:
        	route = "art" + File.separator + "biomorph" + File.separator
            + "proyectiles" + File.separator + "pua_recto3.png";
