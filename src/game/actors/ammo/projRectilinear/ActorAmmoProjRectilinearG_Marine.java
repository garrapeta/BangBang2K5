 ...
 * de los g_marines 
 */
public class ActorAmmoProjRectilinearG_Marine extends ActorAmmoProjRectilinear {
     ...
     */
    public ActorAmmoProjRectilinearG_Marine(Stage stage, ActorPlayer owner,
            int power) {
        super(stage, owner);
        int damage=0;
        int radius=0;
        ...
        case Constants.POW_1:
        	route = "art" + File.separator + "gmarine" + File.separator
            + "proyectiles" + File.separator + "bala_recto1.png";

            this.audioPlayer = new sound.AudioPlayer(stage.getAudioManager(),
                    this.getLogic(),
            "sound.audioProperties.projRectilinear.AudioPropertiesRectilinearGMarine");
        ...
        case Constants.POW_2:
        	route = "art" + File.separator + "gmarine" + File.separator
            + "proyectiles" + File.separator + "bala_recto2.png";
        ...
        case Constants.POW_3:
        	route = "art" + File.separator + "gmarine" + File.separator
            + "proyectiles" + File.separator + "bala_recto3.png";
        ...
        this.newExplosion(new Point(), Explossion.FRACTAL_POLYGON6, 10, 50 + (radius/10));
