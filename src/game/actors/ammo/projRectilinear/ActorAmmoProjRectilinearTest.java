 ...
 * @author CarlosG
 */
public class ActorAmmoProjRectilinearTest extends ActorAmmo {

    public ActorAmmoProjRectilinearTest(Stage stage, ActorPlayer owner) {
        super(owner);
        audioPlayer = new sound.AudioPlayer(stage
                .getAudioManager(), this.getLogic(),"sound.audioProperties.AudioPropertiesGenericRectilinear");
