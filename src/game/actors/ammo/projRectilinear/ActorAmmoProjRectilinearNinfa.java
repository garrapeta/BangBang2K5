 ...
 * de las ninfas
 */
public class ActorAmmoProjRectilinearNinfa extends ActorAmmoProjRectilinear {
     ...
     */
    public ActorAmmoProjRectilinearNinfa(Stage stage, ActorPlayer owner,
            int power) {
        super(stage, owner);
        int damage=0;	
        int radius=0;
        ...
        case Constants.POW_1:
            ...
            this.audioPlayer = new sound.AudioPlayer(stage.getAudioManager(),
                    this.getLogic(),
            "sound.audioProperties.projRectilinear.AudioPropertiesRectilinearNinfa");
