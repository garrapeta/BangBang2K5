 ...
 * funcionalidades concretas al proyectil granada de las ninfas
 */
public class ActorAmmoProjGrenadeNinfa extends ActorAmmoProjGrenade {
     ...
     */
    public ActorAmmoProjGrenadeNinfa(Stage stage, ActorPlayer owner, int power) {
        super(stage, owner);
        int damage=0;	
        int radius=0;
        ...
        case Constants.POW_1:
            ...
            + "proyectiles" + File.separator + "cogollo_rebote1.png";
        ...
        case Constants.POW_2:
        	route = "art" + File.separator + "pibitas" + File.separator
            + "proyectiles" + File.separator + "cogollo_rebote2.png";
        ...
        case Constants.POW_3:
        	route = "art" + File.separator + "pibitas" + File.separator
            + "proyectiles" + File.separator + "cogollo_rebote3.png";
