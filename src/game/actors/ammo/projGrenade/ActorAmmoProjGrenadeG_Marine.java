 ...
 * funcionalidades concretas al proyectil granada de los g_marines
 */
public class ActorAmmoProjGrenadeG_Marine extends ActorAmmoProjGrenade {
     ...
     */
    public ActorAmmoProjGrenadeG_Marine(Stage stage, ActorPlayer owner,
            int power) {
        super(stage, owner);
        int damage=0;	
        int radius=0;
        ...
        this.newExplosion(new Point(), Explossion.FRACTAL_POLYGON6, 10, 50 + (radius/20));
