 ...
 * funcionalidades concretas al proyectil granada de los scrappers
 */
public class ActorAmmoProjGrenadeScrapper extends ActorAmmoProjGrenade {
     ...
     */
    public ActorAmmoProjGrenadeScrapper(Stage stage, ActorPlayer owner,
            int power) {
        super(stage, owner);
        int damage=0;
        int radius=0;
