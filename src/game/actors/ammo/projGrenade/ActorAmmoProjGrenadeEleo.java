 ...
 * funcionalidades concretas al proyectil granada de los nhleos
 */
public class ActorAmmoProjGrenadeEleo extends ActorAmmoProjGrenade {
     ...
     */
    public ActorAmmoProjGrenadeEleo(Stage stage, ActorPlayer owner, int power) {
        super(stage, owner);
        int damage=0;	
        int radius=0;
