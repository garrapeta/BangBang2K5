 ...
 *  
 */
public class AudioPropertiesBiomorph extends AudioProperties {

    public AudioPropertiesBiomorph(AudioManager am) {
        super();
        initProperties(am);
    }
    ...
    public void initProperties(AudioManager am) {
        ...
        ae = new AudioEvent(am, new File("soundFiles" + File.separator
                + "biomorphWalk1.wav"), AudioEvent.START_LOOP);
        loadEvent(ac, ae);
        ...
        ac = new AudioCondition(LogicActor.STATE_MOVING, LogicActor.STATE_ANY,
                LogicActor.STATE_ANY);
        ae = new AudioEvent(am, new File("soundFiles" + File.separator
                + "biomorphWalk1.wav"), AudioEvent.STOP_LOOP);
        loadEvent(ac, ae);
        ...
        ac = new AudioCondition(LogicActor.STATE_ANY, LogicActor.STATE_JUMP,
                LogicActor.STATE_ANY);
        ae = new AudioEvent(am, new File("soundFiles" + File.separator
                + "biomorphJump.wav"), AudioEvent.PLAY);
        loadEvent(ac, ae);
        ...
        ac = new AudioCondition(LogicActor.STATE_ANY, LogicActor.STATE_FALLING,
                LogicActor.STATE_ANY);
        ae = new AudioEvent(am, new File("soundFiles" + File.separator
                + "biomorphFall.wav"), AudioEvent.PLAY);
        loadEvent(ac, ae);
        ...
        ac = new AudioCondition(LogicActor.STATE_JUMP, LogicActor.STATE_ANY,
                LogicActor.STATE_ANY);
        ae = new AudioEvent(am, new File("soundFiles" + File.separator
                + "biomorphLand.wav"), AudioEvent.PLAY);
        loadEvent(ac, ae);
        ...
        ac = new AudioCondition(LogicActor.STATE_ANY, LogicActor.STATE_DYING,
                LogicActor.STATE_ANY);
        ae = new AudioEvent(am, new File("soundFiles" + File.separator
                + "biomorphDie.wav"), AudioEvent.PLAY);
        loadEvent(ac, ae);
        ...
        ae = new AudioEvent(am, new File("soundFiles" + File.separator
                + "biomorphAttacks.wav"), AudioEvent.PLAY);
        loadEvent(ac, ae);
        ...
        ae = new AudioEvent(am, new File("soundFiles" + File.separator
                + "biomorphParabolicA2.wav"), AudioEvent.PLAY);
        loadEvent(ac, ae);
