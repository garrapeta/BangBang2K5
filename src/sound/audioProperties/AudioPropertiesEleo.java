 ...
 *  
 */
public class AudioPropertiesEleo extends AudioProperties {

    public AudioPropertiesEleo(AudioManager am) {
        super();
        initProperties(am);
    }
    ...
    public void initProperties(AudioManager am) {
        ...
        ae = new AudioEvent(am, new File("soundFiles" + File.separator
                + "eleoWalk.wav"), AudioEvent.START_LOOP);
        loadEvent(ac, ae);
        ...
        ac = new AudioCondition(LogicActor.STATE_MOVING, LogicActor.STATE_ANY,
                LogicActor.STATE_ANY);
        ae = new AudioEvent(am, new File("soundFiles" + File.separator
                + "eleoWalk.wav"), AudioEvent.STOP_LOOP);
        loadEvent(ac, ae);
        ...
        ac = new AudioCondition(LogicActor.STATE_ANY, LogicActor.STATE_PREJUMP,
                LogicActor.STATE_ANY);
        ae = new AudioEvent(am, new File("soundFiles" + File.separator
                + "eleoPreJump.wav"), AudioEvent.PLAY);
        loadEvent(ac, ae);
        ...
        ae = new AudioEvent(am, new File("soundFiles" + File.separator
                + "eleoHit.wav"), AudioEvent.PLAY);
        loadEvent(ac, ae);

        ac = new AudioCondition(LogicActor.STATE_ANY,
                LogicActor.STATE_HIT_ON_GROUND, LogicActor.STATE_ANY);
        ae = new AudioEvent(am, new File("soundFiles" + File.separator
                + "biomorphHit.wav"), AudioEvent.PLAY);
        loadEvent(ac, ae);
        ...
        ac = new AudioCondition(LogicActor.STATE_ANY, LogicActor.STATE_DYING,
                LogicActor.STATE_ANY);
        ae = new AudioEvent(am, new File("soundFiles" + File.separator
                + "eleoDie1.wav"), AudioEvent.PLAY);
        loadEvent(ac, ae);
        
        ac = new AudioCondition(LogicActor.STATE_ANY, LogicActor.STATE_DYING,
                LogicActor.STATE_ANY);
        ae = new AudioEvent(am, new File("soundFiles" + File.separator
                + "eleoDie2.wav"), AudioEvent.PLAY);
        loadEvent(ac, ae);
        ...
        ae = new AudioEvent(am, new File("soundFiles" + File.separator
                + "eleoMeleeShot.wav"), AudioEvent.PLAY);
        loadEvent(ac, ae);
        ...
        ae = new AudioEvent(am, new File("soundFiles" + File.separator
                + "eleoParabolicShot1.wav"), AudioEvent.PLAY);
        loadEvent(ac, ae);
        ...
        ae = new AudioEvent(am, new File("soundFiles" + File.separator
                + "eleoParabolicShot2.wav"), AudioEvent.PLAY);
        loadEvent(ac, ae);
        ...
        ae = new AudioEvent(am, new File("soundFiles" + File.separator
                + "genericBeep.wav"), AudioEvent.PLAY);
        loadEvent(ac, ae);
        ...
        ae = new AudioEvent(am, new File("soundFiles" + File.separator
                + "eleoGrenadeShot.wav"), AudioEvent.PLAY);
        loadEvent(ac, ae);
        ...
        ae = new AudioEvent(am, new File("soundFiles" + File.separator
                + "eleoRectilinearShot.wav"), AudioEvent.PLAY);
        loadEvent(ac, ae);
